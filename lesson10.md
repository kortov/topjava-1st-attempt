...
> - Поправил форматирование `spring-db.xml`
> - Уменьшил отступы у навигационной панели
...
> - Починил `SecurityUtil` в `GlobalControllerExceptionHandler`
> - Поправил тесты
> - В JavaScript заменил `var` на `const`
